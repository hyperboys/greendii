...
async function main() {
  ...
  const usersData = [
    ...
    { username: 'wilailuck.kon',   fullName: 'วิไลลักษณ์ คงพลปาน',     initials: 'WK',  role: 'sales2',      email: 'wilailuck@greendii.com',    phone: '0899008936', department: 'ฝ่ายขาย',   position: 'Sales Executive',        lineUserId: 'kung232981',    signatureText: 'Wilailuck Kongponpan',  mustChangePassword: true },
    { username: 'siriya.aru',      fullName: 'สิริญา อรุณจิตต์',        initials: 'SAR', role: 'sales2',      email: 'siriya@greendii.com',       phone: '0641018875', department: 'ฝ่ายขาย',   position: 'Sales Executive',        lineUserId: 'nutarunjit',    signatureText: 'Siriya Arunjit',        mustChangePassword: true },
