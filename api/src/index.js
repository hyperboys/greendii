...
const accountCustomersRoutes = require('./routes/account-customers');
const suppliersRoutes = require('./routes/suppliers');
const productsRoutes = require('./routes/products');
const accountProductsRoutes = require('./routes/account-products');
...
const runningNumbersRoutes = require('./routes/running-numbers');
...
app.use('/api/account-customers', accountCustomersRoutes);
app.use('/api/suppliers', suppliersRoutes);
app.use('/api/products', productsRoutes);
app.use('/api/account-products', accountProductsRoutes);
...
app.use('/api/running-numbers', runningNumbersRoutes);
