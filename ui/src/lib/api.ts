...
export const PrTypesAPI = {
  ...
  create: (data: { name: string; approvalSteps?: PrType['approvalSteps']; sortOrder?: number }) =>
...
export const PRAPI = {
  ...
  revise: (id: string, revisionReason: string) =>
    http.post<PurchaseRequest>(`/pr/${id}/revise`, { revisionReason }).then(r => r.data),
...
export const ReportsAPI = {
  ...
  workOrdersNoPoBySales: (params?: { salesIds?: string; statuses?: string; from?: string; to?: string }) =>
